<?php
    ...
    if (isset($_GET['id']) AND isset($_GET['image_name']))
    {
        ...
        $sql="DELETE FROM fd_catagory WHERE id=$id";
        ...
        if($res) 
        {
            $_SESSION['delete']= "Catagory delete Successfully";
            //redirect to Manage catagory
            header('location:'.SITEURL.'/admin/manage.catagory.php');
        }
        else 
        {
            $_SESSION['delete']= "Catagory delete Failed";
            //redirect to Manage catagory
            header('location:'.SITEURL.'/admin/manage.catagory.php');
        }
    ...
    else
    {
        ...
        header('loaction:'.SITEURL.'/admin/manage.catagory.php');
    }
